...
class ArangoClient:
    ...
    def url_prefix(self):
        ...
        return f'{self._url_prefix}/_db/{self.db}'
    ...
    async def _get(self, **kwargs):
        return await self._session.request(
            "GET", f"{self.url_prefix}/_admin/statistics_description", **kwargs)
    ...
    async def document_create(self, collection, **kwargs):
        return await self._session.request(
            "POST", f"{self.url_prefix}/_api/document/{collection}", **kwargs)

    async def document_replace(self, collection, **kwargs):
        return await self._session.request(
            "PUT", f"{self.url_prefix}/_api/document/{collection}", **kwargs)

    async def document_update(self, collection, **kwargs):
        return await self._session.request(
            "PATCH", f"{self.url_prefix}/_api/document/{collection}", **kwargs)

    async def document_delete(self, collection, **kwargs):
        return await self._session.request(
            "DELETE", f"{self.url_prefix}/_api/document/{collection}", **kwargs)
    ...
    async def _execute(self, **kwargs):
        return await self._session.request(
            "HEAD", f"{self.url_prefix}/_admin/cluster_test", **kwargs)

    async def _update(self, **kwargs):
        return await self._session.request(
            "PATCH", f"{self.url_prefix}/_admin/cluster_test", **kwargs)
    ...
    async def replication(self, **kwargs):
        return await self._session.request(
            "GET", f"{self.url_prefix}/_api/replication/applier_state", **kwargs)

    async def replication_put(self, **kwargs):
        return await self._session.request(
            "PUT", f"{self.url_prefix}/_api/replication/make_slave", **kwargs)
